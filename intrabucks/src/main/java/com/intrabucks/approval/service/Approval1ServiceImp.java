...
//    }
    ...
    public String createApproval1(Approval1_Approval1DTO approval1DTO) {
        ...
        // 기안자 정보 처리
        if (approval1DTO.getEmpId1() != null) {
            ...
            // 결재 문자열 추가
            approvalLineBuilder.append(empId1).append(empName1).append(deptId1).append(approvalState1).append("//-//");
        } else {
            System.out.println("기안자 정보가 없어서 오류 발생");
        }

        // 결재자1 정보 처리
        if (approval1DTO.getEmpId2() != null) {
            ...
            // 결재 문자열 추가
            approvalLineBuilder.append(empId2).append(empName2).append(deptId2).append(approvalState2).append("//-//");
        }

        // 결재자2 정보 처리
        if (approval1DTO.getEmpId3() != null) {
            ...
            // 결재 문자열 추가
            approvalLineBuilder.append(empId3).append(empName3).append(deptId3).append(approvalState3).append("//-//");
        }

        // 결재자3 정보 처리
        if (approval1DTO.getEmpId4() != null) {
            ...
            // 결재 문자열 추가
            approvalLineBuilder.append(empId4).append(empName4).append(deptId4).append(approvalState4);
        }
